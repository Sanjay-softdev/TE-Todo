...
export function AttachmentButtons({ 
  ...
  const buttonBase = "flex-1 flex flex-col items-center justify-center transition-default cursor-pointer border-none py-3.5 rounded-[6px] gap-1.5";
  ...
  return (
    <div className="flex gap-[6px]">
      ...
      <button
        ...
        className={`${buttonBase} bg-[#F5F5F5] hover:bg-[#EAEAEA]`}
      >
        <div className="w-[18px] h-[18px] rounded-full bg-[#1A1A1A] flex items-center justify-center">
          <svg 
            width="10" 
        ...
        <span className="text-[#888888]" style={{ fontSize: '9px', fontWeight: 400 }}>
          Screenshot
        </span>
      </button>
